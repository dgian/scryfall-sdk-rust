...
mod single {
    ...
    fn card() -> Card {
        Card {
            ...
            mana_cost: "{2}{W}{W} // {3}{W}{W}".into(),
            cmc: 9.0,
            type_line: "Sorcery // Sorcery".into(),
            colors: vec![ColorSymbol::W],
            ...
            digital: false,
            rarity: "rare".into(),
            card_back_id: "0aeebaf5-8c7d-4636-9e82-8c27447861f7".into(),
            artist: "Kasia 'Kafis' Zielińska".into(),
            artist_ids: vec!["a662cb71-4770-4b49-8b03-2cf8497049a7".into()],
            illustration_id: "3134f77c-7a7d-48e0-99a6-4f323868e1ef".into(),
            border_color: "black".into(),
            frame: "2015".into(),
            security_stamp: "oval".into(),
            full_art: false,
            textless: false,
            booster: false,
            story_spotlight: false,
            ...
            related_uris: RelatedUris {
                gatherer: "http://some.url".parse::<Url>().unwrap(),
                tcgplayer_infinite_articles: "http://some.url".parse::<Url>().unwrap(),
                tcgplayer_infinite_decks: "http://some.url".parse::<Url>().unwrap(),
                edhrec: "http://some.url".parse::<Url>().unwrap(),
            },
